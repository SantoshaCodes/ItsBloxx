...
var SYSTEM_PROMPT, onRequestPost;
var init_ai = __esm({
  "api/ai.ts"() {
    "use strict";
...
var schemaTypeMap, onRequestGet2, onRequestPost2;
...
// api/images.ts
var ALLOWED_TYPES, MAX_SIZE, onRequestPost4, onRequestGet3;
...
var init_pages_create = __esm({
  "api/pages-create.ts"() {
    ...
    __name(callClaude3, "callClaude");
    __name(buildGeneratePrompt, "buildGeneratePrompt");
    __name(buildJudgePrompt2, "buildJudgePrompt");
...
var init_utils = __esm({
  "../node_modules/linkedom/esm/shared/utils.js"() {
    ...
    init_symbols();
    $String = String;
    getEnd = /* @__PURE__ */ __name((node) => node.nodeType === ELEMENT_NODE ? node[END] : node, "getEnd");
    ignoreCase = /* @__PURE__ */ __name(({ ownerDocument }) => ownerDocument[MIME].ignoreCase, "ignoreCase");
    knownAdjacent = /* @__PURE__ */ __name((prev, next) => {
      prev[NEXT] = next;
      next[PREV] = prev;
    }, "knownAdjacent");
    knownBoundaries = /* @__PURE__ */ __name((prev, current, next) => {
      knownAdjacent(prev, current);
      knownAdjacent(getEnd(current), next);
    }, "knownBoundaries");
    knownSegment = /* @__PURE__ */ __name((prev, start, end, next) => {
      knownAdjacent(prev, start);
      knownAdjacent(getEnd(end), next);
    }, "knownSegment");
    knownSiblings = /* @__PURE__ */ __name((prev, current, next) => {
      knownAdjacent(prev, current);
      knownAdjacent(current, next);
    }, "knownSiblings");
    localCase = /* @__PURE__ */ __name(({ localName, ownerDocument }) => {
      return ownerDocument[MIME].ignoreCase ? localName.toUpperCase() : localName;
    }, "localCase");
    setAdjacent = /* @__PURE__ */ __name((prev, next) => {
      if (prev)
        prev[NEXT] = next;
      if (next)
        next[PREV] = prev;
...
var init_custom_element_registry = __esm({
  "../node_modules/linkedom/esm/interface/custom-element-registry.js"() {
    ...
    attributeChangedCallback = /* @__PURE__ */ __name((element, attributeName, oldValue, newValue) => {
    ...
    createTrigger = /* @__PURE__ */ __name((method, isConnected2) => (element) => {
    ...
    connectedCallback = /* @__PURE__ */ __name((element) => {
      if (reactive) {
    ...
    disconnectedCallback = /* @__PURE__ */ __name((element) => {
      if (reactive) {
...
var init_parse_from_string = __esm({
  "../node_modules/linkedom/esm/shared/parse-from-string.js"() {
    ...
    notParsing = true;
    append2 = /* @__PURE__ */ __name((self, node, active) => {
      const end = self[END];
    ...
    attribute = /* @__PURE__ */ __name((element, end, attribute2, value, active) => {
    ...
    parseFromString = /* @__PURE__ */ __name((document, isHTML, markupLanguage) => {
...
var init_register_html_class = __esm({
  "../node_modules/linkedom/esm/shared/register-html-class.js"() {
    ...
    registerHTMLClass = /* @__PURE__ */ __name((names, Class) => {
...
var init_jsdon = __esm({
  "../node_modules/linkedom/esm/shared/jsdon.js"() {
    ...
    init_symbols();
    init_utils();
    loopSegment = /* @__PURE__ */ __name(({ [NEXT]: next, [END]: end }, json) => {
      while (next !== end) {
    ...
    attrAsJSON = /* @__PURE__ */ __name((attr, json) => {
      json.push(ATTRIBUTE_NODE, attr.name);
      const value = attr[VALUE].trim();
      if (value)
        json.push(value);
    }, "attrAsJSON");
    characterDataAsJSON = /* @__PURE__ */ __name((node, json) => {
      const value = node[VALUE];
      if (value.trim())
        json.push(node.nodeType, value);
    }, "characterDataAsJSON");
    nonElementAsJSON = /* @__PURE__ */ __name((node, json) => {
      json.push(node.nodeType);
      loopSegment(node, json);
    }, "nonElementAsJSON");
    documentTypeAsJSON = /* @__PURE__ */ __name(({ name, publicId, systemId }, json) => {
    ...
    elementAsJSON = /* @__PURE__ */ __name((element, json) => {
...
var init_mutation_observer = __esm({
  "../node_modules/linkedom/esm/interface/mutation-observer.js"() {
    init_functionsRoutes_0_428505668336725();
    init_symbols();
    createRecord = /* @__PURE__ */ __name((type, target, addedNodes, removedNodes, attributeName, oldValue) => ({ type, target, addedNodes, removedNodes, attributeName, oldValue }), "createRecord");
    queueAttribute = /* @__PURE__ */ __name((observer, target, attributeName, attributeFilter, attributeOldValue, oldValue) => {
    ...
    attributeChangedCallback2 = /* @__PURE__ */ __name((element, attributeName, oldValue) => {
    ...
    moCallback = /* @__PURE__ */ __name((element, parentNode) => {
      const { ownerDocument } = element;
      const { active, observers } = ownerDocument[MUTATION_OBSERVER];
      if (active) {
        for (const observer of observers) {
...
var init_attributes = __esm({
  "../node_modules/linkedom/esm/shared/attributes.js"() {
    ...
    setAttribute = /* @__PURE__ */ __name((element, attribute2) => {
    ...
    removeAttribute = /* @__PURE__ */ __name((element, attribute2) => {
      const { [VALUE]: value, name } = attribute2;
...
var init_node2 = __esm({
  "../node_modules/linkedom/esm/interface/node.js"() {
    ...
    init_event_target();
    init_node_list();
    getParentNodeCount = /* @__PURE__ */ __name(({ parentNode }) => {
      let count = 0;
      while (parentNode) {
        count++;
...
var init_text_escaper = __esm({
  "../node_modules/linkedom/esm/shared/text-escaper.js"() {
    ...
    escape2 = /* @__PURE__ */ __name((es) => replace.call(es, ca, pe), "escape");
  }
});
...
var init_node3 = __esm({
  "../node_modules/linkedom/esm/shared/node.js"() {
    ...
    init_symbols();
    init_utils();
    isConnected = /* @__PURE__ */ __name(({ ownerDocument, parentNode }) => {
      while (parentNode) {
    ...
    parentElement = /* @__PURE__ */ __name(({ parentNode }) => {
      if (parentNode) {
    ...
    previousSibling = /* @__PURE__ */ __name(({ [PREV]: prev }) => {
    ...
    nextSibling = /* @__PURE__ */ __name((node) => {
...
var init_non_document_type_child_node = __esm({
  "../node_modules/linkedom/esm/mixin/non-document-type-child-node.js"() {
    ...
    init_constants();
    init_node3();
    nextElementSibling2 = /* @__PURE__ */ __name((node) => {
      let next = nextSibling(node);
      while (next && next.nodeType !== ELEMENT_NODE)
        next = nextSibling(next);
      return next;
    }, "nextElementSibling");
    previousElementSibling = /* @__PURE__ */ __name((node) => {
...
var init_child_node = __esm({
  "../node_modules/linkedom/esm/mixin/child-node.js"() {
    ...
    init_mutation_observer();
    init_custom_element_registry();
    asFragment = /* @__PURE__ */ __name((ownerDocument, nodes) => {
      const fragment = ownerDocument.createDocumentFragment();
      fragment.append(...nodes);
      return fragment;
    }, "asFragment");
    before = /* @__PURE__ */ __name((node, nodes) => {
    ...
    after = /* @__PURE__ */ __name((node, nodes) => {
      const { ownerDocument, parentNode } = node;
      if (parentNode)
        parentNode.insertBefore(
          asFragment(ownerDocument, nodes),
    ...
    replaceWith = /* @__PURE__ */ __name((node, nodes) => {
      const { ownerDocument, parentNode } = node;
      if (parentNode) {
    ...
    remove = /* @__PURE__ */ __name((prev, current, next) => {
...
var init_subselects = __esm({
  "../node_modules/css-select/lib/esm/pseudo-selectors/subselects.js"() {
    ...
    is = /* @__PURE__ */ __name((next, token, options, context, compileToken2) => {
...
var init_matches = __esm({
  "../node_modules/linkedom/esm/shared/matches.js"() {
    ...
    init_utils();
    ({ isArray } = Array);
    isTag3 = /* @__PURE__ */ __name(({ nodeType }) => nodeType === ELEMENT_NODE, "isTag");
    existsOne2 = /* @__PURE__ */ __name((test, elements) => elements.some(
      (element) => isTag3(element) && (test(element) || existsOne2(test, getChildren2(element)))
    ), "existsOne");
    getAttributeValue2 = /* @__PURE__ */ __name((element, name) => name === "class" ? element.classList.value : element.getAttribute(name), "getAttributeValue");
    getChildren2 = /* @__PURE__ */ __name(({ childNodes }) => childNodes, "getChildren");
    getName2 = /* @__PURE__ */ __name((element) => {
      const { localName } = element;
      return ignoreCase(element) ? localName.toLowerCase() : localName;
    }, "getName");
    getParent2 = /* @__PURE__ */ __name(({ parentNode }) => parentNode, "getParent");
    getSiblings2 = /* @__PURE__ */ __name((element) => {
      const { parentNode } = element;
      return parentNode ? getChildren2(parentNode) : element;
    }, "getSiblings");
    getText2 = /* @__PURE__ */ __name((node) => {
      if (isArray(node))
    ...
    hasAttrib2 = /* @__PURE__ */ __name((element, name) => element.hasAttribute(name), "hasAttrib");
    removeSubsets2 = /* @__PURE__ */ __name((nodes) => {
      let { length } = nodes;
      while (length--) {
    ...
    findAll2 = /* @__PURE__ */ __name((test, nodes) => {
      const matches2 = [];
    ...
    findOne2 = /* @__PURE__ */ __name((test, nodes) => {
    ...
    prepareMatch = /* @__PURE__ */ __name((element, selectors) => compile3(
      selectors,
      {
    ...
    matches = /* @__PURE__ */ __name((element, selectors) => is2(
      element,
      selectors,
      {
        strict: true,
...
var init_parent_node = __esm({
  "../node_modules/linkedom/esm/mixin/parent-node.js"() {
    ...
    init_custom_element_registry();
    init_non_document_type_child_node();
    isNode = /* @__PURE__ */ __name((node) => node instanceof Node2, "isNode");
    insert = /* @__PURE__ */ __name((parentNode, child, nodes) => {
...
var init_inner_html = __esm({
  "../node_modules/linkedom/esm/mixin/inner-html.js"() {
    ...
    init_utils();
    getInnerHtml = /* @__PURE__ */ __name((node) => node.childNodes.join(""), "getInnerHtml");
    setInnerHtml = /* @__PURE__ */ __name((node, html) => {
...
var init_esm9 = __esm({
  "../node_modules/uhyphen/esm/index.js"() {
    init_functionsRoutes_0_428505668336725();
    esm_default2 = /* @__PURE__ */ __name((camel) => camel.replace(/(([A-Z0-9])([A-Z0-9][a-z]))|(([a-z0-9]+)([A-Z]))/g, "$2$5-$3$6").toLowerCase(), "default");
  }
});
...
var init_string_map = __esm({
  "../node_modules/linkedom/esm/dom/string-map.js"() {
    ...
    key = /* @__PURE__ */ __name((name) => `data-${esm_default2(name)}`, "key");
    prop = /* @__PURE__ */ __name((name) => name.slice(5).replace(/-([a-z])/g, (_, $1) => $1.toUpperCase()), "prop");
    handler = {
      get(dataset, name) {
        if (name in dataset)
...
var init_token_list = __esm({
  "../node_modules/linkedom/esm/dom/token-list.js"() {
    ...
    init_attr();
    ({ add } = Set.prototype);
    addTokens = /* @__PURE__ */ __name((self, tokens) => {
      for (const token of tokens) {
        if (token)
          add.call(self, token);
      }
    }, "addTokens");
    update = /* @__PURE__ */ __name(({ [OWNER_ELEMENT]: ownerElement, value }) => {
...
var init_css_style_declaration = __esm({
  "../node_modules/linkedom/esm/interface/css-style-declaration.js"() {
    ...
    getKeys = /* @__PURE__ */ __name((style) => [...style.keys()].filter((key2) => key2 !== PRIVATE), "getKeys");
    updateKeys = /* @__PURE__ */ __name((style) => {
...
var init_element = __esm({
  "../node_modules/linkedom/esm/interface/element.js"() {
    ...
    create2 = /* @__PURE__ */ __name((ownerDocument, element, localName) => {
    ...
    isVoid = /* @__PURE__ */ __name(({ localName, ownerDocument }) => {
...
var init_facades = __esm({
  "../node_modules/linkedom/esm/shared/facades.js"() {
    ...
    init_element2();
    init_object();
    illegalConstructor = /* @__PURE__ */ __name(() => {
...
var require_parse = __commonJS({
  "../node_modules/cssom/lib/parse.js"(exports) {
    init_functionsRoutes_0_428505668336725();
    var CSSOM = {};
    CSSOM.parse = /* @__PURE__ */ __name(function parse6(token) {
      var i = 0;
...
var init_mime = __esm({
  "../node_modules/linkedom/esm/shared/mime.js"() {
    init_functionsRoutes_0_428505668336725();
    voidElements2 = { test: /* @__PURE__ */ __name(() => true, "test") };
    Mime = {
      "text/html": {
...
var init_image = __esm({
  "../node_modules/linkedom/esm/interface/image.js"() {
    init_functionsRoutes_0_428505668336725();
    init_image_element();
    ImageClass = /* @__PURE__ */ __name((ownerDocument) => (
      /**
...
var init_range = __esm({
  "../node_modules/linkedom/esm/interface/range.js"() {
    ...
    init_element2();
    init_utils();
    deleteContents = /* @__PURE__ */ __name(({ [START]: start, [END]: end }, fragment = null) => {
...
var init_tree_walker = __esm({
  "../node_modules/linkedom/esm/interface/tree-walker.js"() {
    ...
    init_constants();
    init_symbols();
    isOK = /* @__PURE__ */ __name(({ nodeType }, mask) => {
      switch (nodeType) {
        case ELEMENT_NODE:
...
var import_perf_hooks, query, globalExports, window, Document2;
var init_document = __esm({
  "../node_modules/linkedom/esm/interface/document.js"() {
    ...
    init_text();
    init_tree_walker();
    query = /* @__PURE__ */ __name((method, ownerDocument, selectors) => {
...
var init_document2 = __esm({
  "../node_modules/linkedom/esm/html/document.js"() {
    ...
    init_custom_element_registry();
    init_element3();
    createHTMLElement = /* @__PURE__ */ __name((ownerDocument, builtin, localName, options) => {
...
var init_esm10 = __esm({
  "../node_modules/linkedom/esm/index.js"() {
    ...
    init_node_list();
    init_node_filter();
    parseHTML = /* @__PURE__ */ __name((html, globals = null) => new DOMParser().parseFromString(
      html,
      "text/html",
      globals
...
var BRIDGE_SCRIPT_ID, BRIDGE_STYLE_ID;
...
var ENHANCE_PROMPT, onRequestPost6;
var init_save = __esm({
  "api/save.ts"() {
    "use strict";
    init_functionsRoutes_0_428505668336725();
...
var SCHEMA_TOOLS, SYSTEM_PROMPT2, onRequestPost7;
...
// ../.wrangler/tmp/bundle-v43Vzu/middleware-loader.entry.ts
init_functionsRoutes_0_428505668336725();

// ../.wrangler/tmp/bundle-v43Vzu/middleware-insertion-facade.js
init_functionsRoutes_0_428505668336725();
...
//# sourceMappingURL=functionsWorker-0.9491651213849086.mjs.map
