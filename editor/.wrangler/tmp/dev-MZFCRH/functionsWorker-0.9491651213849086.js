...
// .wrangler/tmp/pages-gXYSU7/functionsWorker-0.9491651213849086.mjs
...
var init_ai = __esm({
  "api/ai.ts"() {
    "use strict";
    init_functionsRoutes_0_428505668336725();
    SYSTEM_PROMPT = `You are Bloxx, an expert web developer that outputs Bootstrap 5.3+ HTML.
...
13. Output complete, self-contained HTML sections \u2014 no partial fragments.`;
    ...
    onRequestPost = /* @__PURE__ */ __name2(async (context) => {
      ...
      try {
        switch (action) {
          case "edit-section": {
            if (!site || !page || sectionIndex === void 0 || !prompt) {
              return Response.json({ ok: false, error: "Missing site, page, sectionIndex, or prompt" }, { status: 400 });
            }
            const key2 = `${site}/drafts/${page}.html`;
            const obj = await env.BLOXX_SITES.get(key2);
          ...
          case "generate-section": {
            ...
            if (site && page) {
              ...
              if (obj) {
                ...
                const headings = Array.from(text.matchAll(/<h[12][^>]*>(.*?)<\/h[12]>/gi)).map((m) => m[1]).join(", ");
                contextHtml = `
...
async function callClaude2(env, model, maxTokens, messages) {
  const res = await fetch("https://api.anthropic.com/v1/messages", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
...
__name(callClaude2, "callClaude2");
function buildEnrichPrompt(type, name, category, prompt, feedback) {
...
SUGGESTIONS:
${feedback.suggestions.map((s, n) => `${n + 1}. ${s}`).join("\n")}
` : "";
...
__name(buildEnrichPrompt, "buildEnrichPrompt");
function buildJudgePrompt(html, schema, data, meta, type) {
...
__name(buildJudgePrompt, "buildJudgePrompt");
var schemaTypeMap;
var onRequestGet2;
var onRequestPost2;
var init_components = __esm({
  "api/components.ts"() {
    ...
    __name2(callClaude2, "callClaude");
    __name2(buildEnrichPrompt, "buildEnrichPrompt");
    __name2(buildJudgePrompt, "buildJudgePrompt");
    onRequestGet2 = /* @__PURE__ */ __name2(async (context) => {
      ...
      try {
        ...
        if (type && type !== "all") {
          components = components.filter((c) => c.type?.toLowerCase() === type.toLowerCase());
        }
    ...
    onRequestPost2 = /* @__PURE__ */ __name2(async (context) => {
      ...
      for (let attempt = 0; attempt <= MAX_RETRIES; attempt++) {
        try {
          ...
          const enrichText = await callClaude2(env, "claude-opus-4-5-20251101", 16384, [
            { role: "user", content: enrichPrompt }
          ]);
          const enriched = extractJSON(enrichText);
          const judgeText = await callClaude2(env, "claude-sonnet-4-20250514", 1024, [
...
var init_images = __esm({
  "api/images.ts"() {
    ...
    onRequestPost4 = /* @__PURE__ */ __name2(async (context) => {
      ...
      const key2 = `${site}/assets/images/${timestamp}-${safeName}`;
      await env.BLOXX_SITES.put(key2, file.stream(), {
        httpMetadata: { contentType: file.type }
      });
      const url = `/preview/${site}/_asset/images/${timestamp}-${safeName}`;
      return Response.json({ ok: true, url, key: key2 });
    }, "onRequestPost");
...
async function callClaude3(env, model, maxTokens, messages) {
  const res = await fetch("https://api.anthropic.com/v1/messages", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
...
__name(callClaude3, "callClaude3");
function buildGeneratePrompt(template, brandContext, feedback) {
  const feedbackSection = feedback ? `
=== PREVIOUS ATTEMPT FEEDBACK (FIX THESE) ===
Score: ${feedback.score}/100
ISSUES:
...
function buildJudgePrompt2(html, schema, meta, template) {
...
__name(buildJudgePrompt2, "buildJudgePrompt2");
var TEMPLATES;
var onRequestPost5;
var init_pages_create = __esm({
  "api/pages-create.ts"() {
    "use strict";
    init_functionsRoutes_0_428505668336725();
    TEMPLATES = {
    ...
    __name2(callClaude3, "callClaude");
    __name2(buildGeneratePrompt, "buildGeneratePrompt");
    __name2(buildJudgePrompt2, "buildJudgePrompt");
    onRequestPost5 = /* @__PURE__ */ __name2(async (context) => {
      ...
      for (let attempt = 0; attempt <= MAX_RETRIES; attempt++) {
        try {
          const genText = await callClaude3(env, "claude-opus-4-5-20251101", 16384, [
            { role: "user", content: buildGeneratePrompt(template, brandContext || "", feedback) }
          ]);
          const generated = extractJSON2(genText);
          const judgeText = await callClaude3(env, "claude-sonnet-4-20250514", 1024, [
            { role: "user", content: buildJudgePrompt2(generated.html, generated.schema, generated.meta, template) }
          ]);
          const judgeResult = extractJSON2(judgeText);
          lastScore = judgeResult.score;
          if (judgeResult.score >= 90) {
...
function getEscaper(regex, map) {
  return /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function escape3(data) {
    let match2;
    let lastIdx = 0;
    let result = "";
...
__export(esm_exports2, {
  ...
  hasChildren: /* @__PURE__ */ __name(() => hasChildren, "hasChildren"),
...
__export(esm_exports3, {
  DefaultHandler: /* @__PURE__ */ __name(() => DomHandler, "DefaultHandler"),
  DomHandler: /* @__PURE__ */ __name(() => DomHandler, "DomHandler"),
  DomUtils: /* @__PURE__ */ __name(() => esm_exports2, "DomUtils"),
  ElementType: /* @__PURE__ */ __name(() => esm_exports, "ElementType"),
  Parser: /* @__PURE__ */ __name(() => Parser, "Parser"),
  QuoteType: /* @__PURE__ */ __name(() => QuoteType, "QuoteType"),
  Tokenizer: /* @__PURE__ */ __name(() => Tokenizer, "Tokenizer"),
  createDocumentStream: /* @__PURE__ */ __name(() => createDocumentStream, "createDocumentStream"),
  createDomStream: /* @__PURE__ */ __name(() => createDomStream, "createDomStream"),
  getFeed: /* @__PURE__ */ __name(() => getFeed, "getFeed"),
  parseDOM: /* @__PURE__ */ __name(() => parseDOM, "parseDOM"),
  parseDocument: /* @__PURE__ */ __name(() => parseDocument, "parseDocument"),
  parseFeed: /* @__PURE__ */ __name(() => parseFeed, "parseFeed")
});
...
var SHOW_ELEMENT;
var SHOW_TEXT;
var SHOW_CDATA_SECTION;
var SHOW_COMMENT;
var DOCUMENT_POSITION_DISCONNECTED;
var DOCUMENT_POSITION_PRECEDING;
var DOCUMENT_POSITION_FOLLOWING;
var DOCUMENT_POSITION_CONTAINS;
...
var init_utils = __esm({
  "../node_modules/linkedom/esm/shared/utils.js"() {
    ...
    init_symbols();
    $String = String;
    getEnd = /* @__PURE__ */ __name2((node) => node.nodeType === ELEMENT_NODE ? node[END] : node, "getEnd");
    ignoreCase = /* @__PURE__ */ __name2(({ ownerDocument }) => ownerDocument[MIME].ignoreCase, "ignoreCase");
    knownAdjacent = /* @__PURE__ */ __name2((prev, next) => {
      prev[NEXT] = next;
      next[PREV] = prev;
    }, "knownAdjacent");
    knownBoundaries = /* @__PURE__ */ __name2((prev, current, next) => {
      knownAdjacent(prev, current);
      knownAdjacent(getEnd(current), next);
    }, "knownBoundaries");
    knownSegment = /* @__PURE__ */ __name2((prev, start, end, next) => {
      knownAdjacent(prev, start);
      knownAdjacent(getEnd(end), next);
    }, "knownSegment");
    knownSiblings = /* @__PURE__ */ __name2((prev, current, next) => {
      knownAdjacent(prev, current);
      knownAdjacent(current, next);
    }, "knownSiblings");
    localCase = /* @__PURE__ */ __name2(({ localName, ownerDocument }) => {
      return ownerDocument[MIME].ignoreCase ? localName.toUpperCase() : localName;
    }, "localCase");
    setAdjacent = /* @__PURE__ */ __name2((prev, next) => {
      if (prev)
        prev[NEXT] = next;
      if (next)
        next[PREV] = prev;
...
var createTrigger;
var triggerConnected;
var connectedCallback;
var triggerDisconnected;
...
var init_custom_element_registry = __esm({
  "../node_modules/linkedom/esm/interface/custom-element-registry.js"() {
    ...
    attributeChangedCallback = /* @__PURE__ */ __name2((element, attributeName, oldValue, newValue) => {
    ...
    createTrigger = /* @__PURE__ */ __name2((method, isConnected2) => (element) => {
    ...
    connectedCallback = /* @__PURE__ */ __name2((element) => {
      if (reactive) {
    ...
    disconnectedCallback = /* @__PURE__ */ __name2((element) => {
      if (reactive) {
    ...
    CustomElementRegistry = class {
      ...
      static {
        __name2(this, "CustomElementRegistry");
      }
      /**
...
var init_parse_from_string = __esm({
  "../node_modules/linkedom/esm/shared/parse-from-string.js"() {
    ...
    notParsing = true;
    append2 = /* @__PURE__ */ __name2((self, node, active) => {
      const end = self[END];
    ...
    attribute = /* @__PURE__ */ __name2((element, end, attribute2, value, active) => {
    ...
    parseFromString = /* @__PURE__ */ __name2((document, isHTML, markupLanguage) => {
...
var init_register_html_class = __esm({
  "../node_modules/linkedom/esm/shared/register-html-class.js"() {
    ...
    registerHTMLClass = /* @__PURE__ */ __name2((names, Class) => {
...
var loopSegment;
var attrAsJSON;
var characterDataAsJSON;
var nonElementAsJSON;
var documentTypeAsJSON;
var elementAsJSON;
var init_jsdon = __esm({
  "../node_modules/linkedom/esm/shared/jsdon.js"() {
    ...
    init_symbols();
    init_utils();
    loopSegment = /* @__PURE__ */ __name2(({ [NEXT]: next, [END]: end }, json) => {
      while (next !== end) {
    ...
    attrAsJSON = /* @__PURE__ */ __name2((attr, json) => {
      json.push(ATTRIBUTE_NODE, attr.name);
      const value = attr[VALUE].trim();
      if (value)
        json.push(value);
    }, "attrAsJSON");
    characterDataAsJSON = /* @__PURE__ */ __name2((node, json) => {
      const value = node[VALUE];
      if (value.trim())
        json.push(node.nodeType, value);
    }, "characterDataAsJSON");
    nonElementAsJSON = /* @__PURE__ */ __name2((node, json) => {
      json.push(node.nodeType);
      loopSegment(node, json);
    }, "nonElementAsJSON");
    documentTypeAsJSON = /* @__PURE__ */ __name2(({ name, publicId, systemId }, json) => {
    ...
    elementAsJSON = /* @__PURE__ */ __name2((element, json) => {
...
var init_mutation_observer = __esm({
  "../node_modules/linkedom/esm/interface/mutation-observer.js"() {
    init_functionsRoutes_0_428505668336725();
    init_symbols();
    createRecord = /* @__PURE__ */ __name2((type, target, addedNodes, removedNodes, attributeName, oldValue) => ({ type, target, addedNodes, removedNodes, attributeName, oldValue }), "createRecord");
    queueAttribute = /* @__PURE__ */ __name2((observer, target, attributeName, attributeFilter, attributeOldValue, oldValue) => {
    ...
    attributeChangedCallback2 = /* @__PURE__ */ __name2((element, attributeName, oldValue) => {
    ...
    moCallback = /* @__PURE__ */ __name2((element, parentNode) => {
      const { ownerDocument } = element;
      const { active, observers } = ownerDocument[MUTATION_OBSERVER];
      if (active) {
        for (const observer of observers) {
    ...
    MutationObserverClass = class {
      ...
      static {
        __name2(this, "MutationObserverClass");
      }
      constructor(ownerDocument) {
...
var init_attributes = __esm({
  "../node_modules/linkedom/esm/shared/attributes.js"() {
    ...
    setAttribute = /* @__PURE__ */ __name2((element, attribute2) => {
    ...
    removeAttribute = /* @__PURE__ */ __name2((element, attribute2) => {
      const { [VALUE]: value, name } = attribute2;
...
var init_event_target = __esm({
  "../node_modules/linkedom/esm/interface/event-target.js"() {
    ...
    __name2(invokeListeners, "invokeListeners");
    DOMEventTarget = class {
      static {
        __name(this, "DOMEventTarget");
      }
      static {
        __name2(this, "DOMEventTarget");
      }
      constructor() {
...
var init_node2 = __esm({
  "../node_modules/linkedom/esm/interface/node.js"() {
    ...
    init_event_target();
    init_node_list();
    getParentNodeCount = /* @__PURE__ */ __name2(({ parentNode }) => {
      let count = 0;
      while (parentNode) {
        count++;
...
var init_text_escaper = __esm({
  "../node_modules/linkedom/esm/shared/text-escaper.js"() {
    ...
    pe = /* @__PURE__ */ __name2((m) => esca[m], "pe");
    escape2 = /* @__PURE__ */ __name2((es) => replace.call(es, ca, pe), "escape");
  }
});
var QUOTE;
var Attr;
...
var init_node3 = __esm({
  "../node_modules/linkedom/esm/shared/node.js"() {
    ...
    init_symbols();
    init_utils();
    isConnected = /* @__PURE__ */ __name2(({ ownerDocument, parentNode }) => {
      while (parentNode) {
    ...
    parentElement = /* @__PURE__ */ __name2(({ parentNode }) => {
      if (parentNode) {
    ...
    previousSibling = /* @__PURE__ */ __name2(({ [PREV]: prev }) => {
    ...
    nextSibling = /* @__PURE__ */ __name2((node) => {
...
var init_non_document_type_child_node = __esm({
  "../node_modules/linkedom/esm/mixin/non-document-type-child-node.js"() {
    ...
    init_constants();
    init_node3();
    nextElementSibling2 = /* @__PURE__ */ __name2((node) => {
      let next = nextSibling(node);
      while (next && next.nodeType !== ELEMENT_NODE)
        next = nextSibling(next);
      return next;
    }, "nextElementSibling");
    previousElementSibling = /* @__PURE__ */ __name2((node) => {
...
var init_child_node = __esm({
  "../node_modules/linkedom/esm/mixin/child-node.js"() {
    ...
    init_mutation_observer();
    init_custom_element_registry();
    asFragment = /* @__PURE__ */ __name2((ownerDocument, nodes) => {
      const fragment = ownerDocument.createDocumentFragment();
      fragment.append(...nodes);
      return fragment;
    }, "asFragment");
    before = /* @__PURE__ */ __name2((node, nodes) => {
    ...
    after = /* @__PURE__ */ __name2((node, nodes) => {
      const { ownerDocument, parentNode } = node;
      if (parentNode)
        parentNode.insertBefore(
          asFragment(ownerDocument, nodes),
    ...
    replaceWith = /* @__PURE__ */ __name2((node, nodes) => {
      const { ownerDocument, parentNode } = node;
      if (parentNode) {
    ...
    remove = /* @__PURE__ */ __name2((prev, current, next) => {
...
var init_cdata_section = __esm({
  "../node_modules/linkedom/esm/interface/cdata-section.js"() {
    ...
    CDATASection = class _CDATASection extends CharacterData {
      static {
        __name(this, "_CDATASection");
      }
      static {
        __name2(this, "CDATASection");
      }
...
function parseSelector(subselects2, selector, selectorIndex) {
  ...
  __name(getName3, "getName3");
  __name2(getName3, "getName");
...
function dynamicStatePseudo(name) {
  return /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function dynamicPseudo(next, _rule, { adapter: adapter2 }) {
...
var init_subselects = __esm({
  "../node_modules/css-select/lib/esm/pseudo-selectors/subselects.js"() {
    ...
    is = /* @__PURE__ */ __name2((next, token, options, context, compileToken2) => {
...
function getSelectorFunc(searchFunc) {
  return /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function select(query2, elements, options) {
    const opts = convertOptionFormats(options);
...
var init_esm8 = __esm({
  "../node_modules/css-select/lib/esm/index.js"() {
    ...
    init_subselects();
    init_pseudo_selectors();
    defaultEquals = /* @__PURE__ */ __name2((a, b) => a === b, "defaultEquals");
    defaultOptions = {
...
var init_matches = __esm({
  "../node_modules/linkedom/esm/shared/matches.js"() {
    ...
    init_utils();
    ({ isArray } = Array);
    isTag3 = /* @__PURE__ */ __name2(({ nodeType }) => nodeType === ELEMENT_NODE, "isTag");
    existsOne2 = /* @__PURE__ */ __name2((test, elements) => elements.some(
      (element) => isTag3(element) && (test(element) || existsOne2(test, getChildren2(element)))
    ), "existsOne");
    getAttributeValue2 = /* @__PURE__ */ __name2((element, name) => name === "class" ? element.classList.value : element.getAttribute(name), "getAttributeValue");
    getChildren2 = /* @__PURE__ */ __name2(({ childNodes }) => childNodes, "getChildren");
    getName2 = /* @__PURE__ */ __name2((element) => {
      const { localName } = element;
      return ignoreCase(element) ? localName.toLowerCase() : localName;
    }, "getName");
    getParent2 = /* @__PURE__ */ __name2(({ parentNode }) => parentNode, "getParent");
    getSiblings2 = /* @__PURE__ */ __name2((element) => {
      const { parentNode } = element;
      return parentNode ? getChildren2(parentNode) : element;
    }, "getSiblings");
    getText2 = /* @__PURE__ */ __name2((node) => {
      if (isArray(node))
    ...
    hasAttrib2 = /* @__PURE__ */ __name2((element, name) => element.hasAttribute(name), "hasAttrib");
    removeSubsets2 = /* @__PURE__ */ __name2((nodes) => {
      let { length } = nodes;
      while (length--) {
    ...
    findAll2 = /* @__PURE__ */ __name2((test, nodes) => {
      const matches2 = [];
    ...
    findOne2 = /* @__PURE__ */ __name2((test, nodes) => {
    ...
    prepareMatch = /* @__PURE__ */ __name2((element, selectors) => compile3(
      selectors,
      {
    ...
    matches = /* @__PURE__ */ __name2((element, selectors) => is2(
      element,
      selectors,
      {
        strict: true,
...
var init_parent_node = __esm({
  "../node_modules/linkedom/esm/mixin/parent-node.js"() {
    ...
    init_custom_element_registry();
    init_non_document_type_child_node();
    isNode = /* @__PURE__ */ __name2((node) => node instanceof Node2, "isNode");
    insert = /* @__PURE__ */ __name2((parentNode, child, nodes) => {
...
var init_non_element_parent_node = __esm({
  "../node_modules/linkedom/esm/mixin/non-element-parent-node.js"() {
    ...
    NonElementParentNode = class extends ParentNode {
      ...
      static {
        __name2(this, "NonElementParentNode");
      }
      getElementById(id) {
        let { [NEXT]: next, [END]: end } = this;
        while (next !== end) {
...
var init_document_type = __esm({
  "../node_modules/linkedom/esm/interface/document-type.js"() {
    ...
    DocumentType = class _DocumentType extends Node2 {
      static {
        __name(this, "_DocumentType");
      }
      static {
        __name2(this, "DocumentType");
      }
...
var init_inner_html = __esm({
  "../node_modules/linkedom/esm/mixin/inner-html.js"() {
    ...
    init_utils();
    getInnerHtml = /* @__PURE__ */ __name2((node) => node.childNodes.join(""), "getInnerHtml");
    setInnerHtml = /* @__PURE__ */ __name2((node, html) => {
    ...
    __name2(setOwnerDocument, "setOwnerDocument");
  }
});
var esm_default2;
var init_esm9 = __esm({
  "../node_modules/uhyphen/esm/index.js"() {
    init_functionsRoutes_0_428505668336725();
    esm_default2 = /* @__PURE__ */ __name2((camel) => camel.replace(/(([A-Z0-9])([A-Z0-9][a-z]))|(([a-z0-9]+)([A-Z]))/g, "$2$5-$3$6").toLowerCase(), "default");
  }
});
var refs;
var key;
...
var init_string_map = __esm({
  "../node_modules/linkedom/esm/dom/string-map.js"() {
    ...
    key = /* @__PURE__ */ __name2((name) => `data-${esm_default2(name)}`, "key");
    prop = /* @__PURE__ */ __name2((name) => name.slice(5).replace(/-([a-z])/g, (_, $1) => $1.toUpperCase()), "prop");
    handler = {
      get(dataset, name) {
        if (name in dataset)
...
var init_token_list = __esm({
  "../node_modules/linkedom/esm/dom/token-list.js"() {
    ...
    init_attr();
    ({ add } = Set.prototype);
    addTokens = /* @__PURE__ */ __name2((self, tokens) => {
      for (const token of tokens) {
        if (token)
          add.call(self, token);
      }
    }, "addTokens");
    update = /* @__PURE__ */ __name2(({ [OWNER_ELEMENT]: ownerElement, value }) => {
...
var init_css_style_declaration = __esm({
  "../node_modules/linkedom/esm/interface/css-style-declaration.js"() {
    ...
    getKeys = /* @__PURE__ */ __name2((style) => [...style.keys()].filter((key2) => key2 !== PRIVATE), "getKeys");
    updateKeys = /* @__PURE__ */ __name2((style) => {
    ...
    CSSStyleDeclaration = class extends Map {
      ...
      static {
        __name2(this, "CSSStyleDeclaration");
      }
      constructor(element) {
        super();
...
var init_event = __esm({
  "../node_modules/linkedom/esm/interface/event.js"() {
    ...
    CAPTURING_PHASE = 1;
    NONE = 0;
    __name2(getCurrentTarget, "getCurrentTarget");
    GlobalEvent = class {
      static {
        __name(this, "GlobalEvent");
      }
      static {
        __name2(this, "GlobalEvent");
      }
...
var init_element = __esm({
  "../node_modules/linkedom/esm/interface/element.js"() {
    ...
    create2 = /* @__PURE__ */ __name2((ownerDocument, element, localName) => {
    ...
    isVoid = /* @__PURE__ */ __name2(({ localName, ownerDocument }) => {
      return ownerDocument[MIME].voidElements.test(localName);
    }, "isVoid");
    Element2 = class extends ParentNode {
      static {
        __name(this, "Element2");
      }
      static {
        __name2(this, "Element");
      }
      ...
      cloneNode(deep = false) {
        ...
        const addNext = /* @__PURE__ */ __name2((next2) => {
...
__name(CDATASection2, "CDATASection2");
function CharacterData2() {
  illegalConstructor();
}
__name(CharacterData2, "CharacterData2");
function Comment4() {
  illegalConstructor();
}
__name(Comment4, "Comment4");
function DocumentFragment2() {
  illegalConstructor();
}
__name(DocumentFragment2, "DocumentFragment2");
function DocumentType2() {
  illegalConstructor();
}
__name(DocumentType2, "DocumentType2");
function Element3() {
  illegalConstructor();
}
__name(Element3, "Element3");
function Node3() {
  illegalConstructor();
}
__name(Node3, "Node3");
...
__name(ShadowRoot2, "ShadowRoot2");
function Text4() {
  illegalConstructor();
}
__name(Text4, "Text4");
...
__name(SVGElement2, "SVGElement2");
...
var init_facades = __esm({
  "../node_modules/linkedom/esm/shared/facades.js"() {
    ...
    __name2(ShadowRoot2, "ShadowRoot");
    ...
    __name2(SVGElement2, "SVGElement");
...
var init_template_element = __esm({
  "../node_modules/linkedom/esm/html/template-element.js"() {
    ...
    HTMLTemplateElement = class extends HTMLElement {
      ...
      static {
        __name2(this, "HTMLTemplateElement");
      }
      constructor(ownerDocument) {
...
var init_script_element = __esm({
  "../node_modules/linkedom/esm/html/script-element.js"() {
    ...
    HTMLScriptElement = class extends TextElement {
      ...
      static {
        __name2(this, "HTMLScriptElement");
      }
...
var init_i_frame_element = __esm({
  "../node_modules/linkedom/esm/html/i-frame-element.js"() {
    ...
    HTMLIFrameElement = class extends HTMLElement {
      ...
      static {
        __name2(this, "HTMLIFrameElement");
      }
...
var init_object_element = __esm({
  "../node_modules/linkedom/esm/html/object-element.js"() {
    ...
    HTMLObjectElement = class extends HTMLElement {
      ...
      static {
        __name2(this, "HTMLObjectElement");
      }
...
var require_StyleSheet = __commonJS({
  "../node_modules/cssom/lib/StyleSheet.js"(exports) {
    init_functionsRoutes_0_428505668336725();
    var CSSOM = {};
    CSSOM.StyleSheet = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function StyleSheet() {
...
var require_CSSRule = __commonJS({
  "../node_modules/cssom/lib/CSSRule.js"(exports) {
    init_functionsRoutes_0_428505668336725();
    var CSSOM = {};
    CSSOM.CSSRule = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function CSSRule() {
...
var require_CSSStyleRule = __commonJS({
  "../node_modules/cssom/lib/CSSStyleRule.js"(exports) {
    ...
    CSSOM.CSSStyleRule = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function CSSStyleRule() {
    ...
    Object.defineProperty(CSSOM.CSSStyleRule.prototype, "cssText", {
      ...
      set: /* @__PURE__ */ __name2(function(cssText) {
...
var require_CSSStyleSheet = __commonJS({
  "../node_modules/cssom/lib/CSSStyleSheet.js"(exports) {
    ...
    CSSOM.CSSStyleSheet = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function CSSStyleSheet() {
...
var require_MediaList = __commonJS({
  "../node_modules/cssom/lib/MediaList.js"(exports) {
    init_functionsRoutes_0_428505668336725();
    var CSSOM = {};
    CSSOM.MediaList = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function MediaList() {
      this.length = 0;
    }, "MediaList"), "MediaList");
    CSSOM.MediaList.prototype = {
       ...
       * @param {string} medium
       */
      appendMedium: /* @__PURE__ */ __name2(function(medium) {
       ...
       * @param {string} medium
       */
      deleteMedium: /* @__PURE__ */ __name2(function(medium) {
...
var require_CSSImportRule = __commonJS({
  "../node_modules/cssom/lib/CSSImportRule.js"(exports) {
    ...
    CSSOM.CSSImportRule = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function CSSImportRule() {
      CSSOM.CSSRule.call(this);
      this.href = "";
...
var require_CSSGroupingRule = __commonJS({
  "../node_modules/cssom/lib/CSSGroupingRule.js"(exports) {
    ...
    CSSOM.CSSGroupingRule = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function CSSGroupingRule() {
      CSSOM.CSSRule.call(this);
      this.cssRules = [];
    }, "CSSGroupingRule"), "CSSGroupingRule");
    CSSOM.CSSGroupingRule.prototype = new CSSOM.CSSRule();
    CSSOM.CSSGroupingRule.prototype.constructor = CSSOM.CSSGroupingRule;
    CSSOM.CSSGroupingRule.prototype.insertRule = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function insertRule(rule, index) {
      if (index < 0 || index > this.cssRules.length) {
        throw new RangeError("INDEX_SIZE_ERR");
      }
      var cssRule = CSSOM.parse(rule).cssRules[0];
    ...
    CSSOM.CSSGroupingRule.prototype.deleteRule = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function deleteRule(index) {
      if (index < 0 || index >= this.cssRules.length) {
        throw new RangeError("INDEX_SIZE_ERR");
      }
...
var require_CSSConditionRule = __commonJS({
  "../node_modules/cssom/lib/CSSConditionRule.js"(exports) {
    ...
    CSSOM.CSSConditionRule = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function CSSConditionRule() {
...
var require_CSSMediaRule = __commonJS({
  "../node_modules/cssom/lib/CSSMediaRule.js"(exports) {
    ...
    CSSOM.CSSMediaRule = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function CSSMediaRule() {
...
var require_CSSSupportsRule = __commonJS({
  "../node_modules/cssom/lib/CSSSupportsRule.js"(exports) {
    ...
    CSSOM.CSSSupportsRule = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function CSSSupportsRule() {
      CSSOM.CSSConditionRule.call(this);
...
var require_CSSFontFaceRule = __commonJS({
  "../node_modules/cssom/lib/CSSFontFaceRule.js"(exports) {
    ...
    CSSOM.CSSFontFaceRule = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function CSSFontFaceRule() {
      CSSOM.CSSRule.call(this);
      this.style = new CSSOM.CSSStyleDeclaration();
      this.style.parentRule = this;
...
var require_CSSHostRule = __commonJS({
  "../node_modules/cssom/lib/CSSHostRule.js"(exports) {
    ...
    CSSOM.CSSHostRule = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function CSSHostRule() {
      CSSOM.CSSRule.call(this);
      this.cssRules = [];
    }, "CSSHostRule"), "CSSHostRule");
...
var require_CSSKeyframeRule = __commonJS({
  "../node_modules/cssom/lib/CSSKeyframeRule.js"(exports) {
    ...
    CSSOM.CSSKeyframeRule = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function CSSKeyframeRule() {
      CSSOM.CSSRule.call(this);
      this.keyText = "";
      this.style = new CSSOM.CSSStyleDeclaration();
      this.style.parentRule = this;
...
var require_CSSKeyframesRule = __commonJS({
  "../node_modules/cssom/lib/CSSKeyframesRule.js"(exports) {
    ...
    CSSOM.CSSKeyframesRule = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function CSSKeyframesRule() {
      CSSOM.CSSRule.call(this);
      this.name = "";
      this.cssRules = [];
...
var require_CSSValue = __commonJS({
  "../node_modules/cssom/lib/CSSValue.js"(exports) {
    init_functionsRoutes_0_428505668336725();
    var CSSOM = {};
    CSSOM.CSSValue = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function CSSValue() {
    }, "CSSValue"), "CSSValue");
    CSSOM.CSSValue.prototype = {
      ...
      _getConstructorName: /* @__PURE__ */ __name2(function() {
...
var require_CSSValueExpression = __commonJS({
  "../node_modules/cssom/lib/CSSValueExpression.js"(exports) {
    ...
    CSSOM.CSSValueExpression = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function CSSValueExpression(token, idx) {
      this._token = token;
      this._idx = idx;
    }, "CSSValueExpression"), "CSSValueExpression");
...
var require_MatcherList = __commonJS({
  "../node_modules/cssom/lib/MatcherList.js"(exports) {
    init_functionsRoutes_0_428505668336725();
    var CSSOM = {};
    CSSOM.MatcherList = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function MatcherList() {
      this.length = 0;
    ...
    CSSOM.MatcherList.prototype = {
       ...
       */
      appendMatcher: /* @__PURE__ */ __name2(function(matcher) {
       ...
       * @param {string} matcher
       */
      deleteMatcher: /* @__PURE__ */ __name2(function(matcher) {
...
var require_CSSDocumentRule = __commonJS({
  "../node_modules/cssom/lib/CSSDocumentRule.js"(exports) {
    ...
    CSSOM.CSSDocumentRule = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function CSSDocumentRule() {
      CSSOM.CSSRule.call(this);
      this.matcher = new CSSOM.MatcherList();
      this.cssRules = [];
    }, "CSSDocumentRule"), "CSSDocumentRule");
...
var require_parse = __commonJS({
  "../node_modules/cssom/lib/parse.js"(exports) {
    init_functionsRoutes_0_428505668336725();
    var CSSOM = {};
    CSSOM.parse = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function parse6(token) {
      var i = 0;
...
var require_CSSStyleDeclaration = __commonJS({
  "../node_modules/cssom/lib/CSSStyleDeclaration.js"(exports) {
    init_functionsRoutes_0_428505668336725();
    var CSSOM = {};
    CSSOM.CSSStyleDeclaration = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function CSSStyleDeclaration2() {
      this.length = 0;
      this.parentRule = null;
      this._importants = {};
    }, "CSSStyleDeclaration2"), "CSSStyleDeclaration");
    CSSOM.CSSStyleDeclaration.prototype = {
       ...
       */
      getPropertyValue: /* @__PURE__ */ __name2(function(name) {
        return this[name] || "";
      }, "getPropertyValue"),
      /**
       *
       ...
       */
      setProperty: /* @__PURE__ */ __name2(function(name, value, priority) {
        if (this[name]) {
       ...
       */
      removeProperty: /* @__PURE__ */ __name2(function(name) {
        if (!(name in this)) {
          return "";
        }
        var index = Array.prototype.indexOf.call(this, name);
      ...
      getPropertyCSSValue: /* @__PURE__ */ __name2(function() {
      }, "getPropertyCSSValue"),
      /**
       *
       * @param {String} name
       */
      getPropertyPriority: /* @__PURE__ */ __name2(function(name) {
       ...
       *   -> "overflow"
       */
      getPropertyShorthand: /* @__PURE__ */ __name2(function() {
      }, "getPropertyShorthand"),
      isPropertyImplicit: /* @__PURE__ */ __name2(function() {
      }, "isPropertyImplicit"),
...
var require_clone = __commonJS({
  "../node_modules/cssom/lib/clone.js"(exports) {
    ...
    CSSOM.clone = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function clone(stylesheet) {
...
var init_field_set_element = __esm({
  "../node_modules/linkedom/esm/html/field-set-element.js"() {
    ...
    HTMLFieldSetElement = class extends HTMLElement {
      ...
      static {
        __name2(this, "HTMLFieldSetElement");
      }
...
var init_progress_element = __esm({
  "../node_modules/linkedom/esm/html/progress-element.js"() {
    ...
    HTMLProgressElement = class extends HTMLElement {
      ...
      static {
        __name2(this, "HTMLProgressElement");
      }
...
var init_paragraph_element = __esm({
  "../node_modules/linkedom/esm/html/paragraph-element.js"() {
    ...
    HTMLParagraphElement = class extends HTMLElement {
      ...
      static {
        __name2(this, "HTMLParagraphElement");
      }
...
var init_frame_set_element = __esm({
  "../node_modules/linkedom/esm/html/frame-set-element.js"() {
    ...
    HTMLFrameSetElement = class extends HTMLElement {
      ...
      static {
        __name2(this, "HTMLFrameSetElement");
      }
...
var init_data_list_element = __esm({
  "../node_modules/linkedom/esm/html/data-list-element.js"() {
    ...
    HTMLDataListElement = class extends HTMLElement {
      ...
      static {
        __name2(this, "HTMLDataListElement");
      }
...
var init_heading_element = __esm({
  "../node_modules/linkedom/esm/html/heading-element.js"() {
    ...
    HTMLHeadingElement = class extends HTMLElement {
      ...
      static {
        __name2(this, "HTMLHeadingElement");
      }
...
var init_directory_element = __esm({
  "../node_modules/linkedom/esm/html/directory-element.js"() {
    ...
    HTMLDirectoryElement = class extends HTMLElement {
      ...
      static {
        __name2(this, "HTMLDirectoryElement");
      }
...
var require_canvas_shim = __commonJS({
  "../node_modules/linkedom/commonjs/canvas-shim.cjs"(exports, module) {
    ...
    module.exports = {
      createCanvas: /* @__PURE__ */ __name2((width, height) => new Canvas2(width, height), "createCanvas")
    };
  }
});
...
var init_canvas_element = __esm({
  "../node_modules/linkedom/esm/html/canvas-element.js"() {
    ...
    HTMLCanvasElement = class extends HTMLElement {
      ...
      static {
        __name2(this, "HTMLCanvasElement");
      }
...
var init_legend_element = __esm({
  "../node_modules/linkedom/esm/html/legend-element.js"() {
    ...
    HTMLLegendElement = class extends HTMLElement {
      ...
      static {
        __name2(this, "HTMLLegendElement");
      }
...
var init_option_element = __esm({
  "../node_modules/linkedom/esm/html/option-element.js"() {
    ...
    HTMLOptionElement = class extends HTMLElement {
      ...
      static {
        __name2(this, "HTMLOptionElement");
      }
...
var init_table_cell_element = __esm({
  "../node_modules/linkedom/esm/html/table-cell-element.js"() {
    ...
    HTMLTableCellElement = class extends HTMLElement {
      ...
      static {
        __name2(this, "HTMLTableCellElement");
      }
...
var init_output_element = __esm({
  "../node_modules/linkedom/esm/html/output-element.js"() {
    ...
    HTMLOutputElement = class extends HTMLElement {
      ...
      static {
        __name2(this, "HTMLOutputElement");
      }
...
var init_table_row_element = __esm({
  "../node_modules/linkedom/esm/html/table-row-element.js"() {
    ...
    HTMLTableRowElement = class extends HTMLElement {
      ...
      static {
        __name2(this, "HTMLTableRowElement");
      }
...
var init_select_element = __esm({
  "../node_modules/linkedom/esm/html/select-element.js"() {
    ...
    HTMLSelectElement = class extends HTMLElement {
      ...
      static {
        __name2(this, "HTMLSelectElement");
      }
...
var init_button_element = __esm({
  "../node_modules/linkedom/esm/html/button-element.js"() {
    ...
    HTMLButtonElement = class extends HTMLElement {
      ...
      static {
        __name2(this, "HTMLButtonElement");
      }
...
var init_opt_group_element = __esm({
  "../node_modules/linkedom/esm/html/opt-group-element.js"() {
    ...
    HTMLOptGroupElement = class extends HTMLElement {
      ...
      static {
        __name2(this, "HTMLOptGroupElement");
      }
...
var init_text_area_element = __esm({
  "../node_modules/linkedom/esm/html/text-area-element.js"() {
    ...
    HTMLTextAreaElement = class extends TextElement {
      ...
      static {
        __name2(this, "HTMLTextAreaElement");
      }
...
var init_picture_element = __esm({
  "../node_modules/linkedom/esm/html/picture-element.js"() {
    ...
    HTMLPictureElement = class extends HTMLElement {
      ...
      static {
        __name2(this, "HTMLPictureElement");
      }
...
var init_table_caption_element = __esm({
  "../node_modules/linkedom/esm/html/table-caption-element.js"() {
    ...
    HTMLTableCaptionElement = class extends HTMLElement {
      ...
      static {
        __name2(this, "HTMLTableCaptionElement");
      }
...
var init_anchor_element = __esm({
  "../node_modules/linkedom/esm/html/anchor-element.js"() {
    ...
    HTMLAnchorElement = class extends HTMLElement {
      ...
      static {
        __name2(this, "HTMLAnchorElement");
      }
...
var init_unknown_element = __esm({
  "../node_modules/linkedom/esm/html/unknown-element.js"() {
    ...
    HTMLUnknownElement = class extends HTMLElement {
      ...
      static {
        __name2(this, "HTMLUnknownElement");
      }
...
var init_details_element = __esm({
  "../node_modules/linkedom/esm/html/details-element.js"() {
    ...
    HTMLDetailsElement = class extends HTMLElement {
      ...
      static {
        __name2(this, "HTMLDetailsElement");
      }
...
var init_source_element = __esm({
  "../node_modules/linkedom/esm/html/source-element.js"() {
    ...
    HTMLSourceElement = class extends HTMLElement {
      ...
      static {
        __name2(this, "HTMLSourceElement");
      }
...
var init_marquee_element = __esm({
  "../node_modules/linkedom/esm/html/marquee-element.js"() {
    ...
    HTMLMarqueeElement = class extends HTMLElement {
      ...
      static {
        __name2(this, "HTMLMarqueeElement");
      }
...
var init_mime = __esm({
  "../node_modules/linkedom/esm/shared/mime.js"() {
    init_functionsRoutes_0_428505668336725();
    voidElements2 = { test: /* @__PURE__ */ __name2(() => true, "test") };
    Mime = {
      "text/html": {
...
var init_image = __esm({
  "../node_modules/linkedom/esm/interface/image.js"() {
    init_functionsRoutes_0_428505668336725();
    init_image_element();
    ImageClass = /* @__PURE__ */ __name2((ownerDocument) => (
      /**
...
var init_range = __esm({
  "../node_modules/linkedom/esm/interface/range.js"() {
    ...
    init_element2();
    init_utils();
    deleteContents = /* @__PURE__ */ __name2(({ [START]: start, [END]: end }, fragment = null) => {
...
var init_tree_walker = __esm({
  "../node_modules/linkedom/esm/interface/tree-walker.js"() {
    ...
    init_constants();
    init_symbols();
    isOK = /* @__PURE__ */ __name2(({ nodeType }, mask) => {
      switch (nodeType) {
        case ELEMENT_NODE:
...
var init_document = __esm({
  "../node_modules/linkedom/esm/interface/document.js"() {
    ...
    init_text();
    init_tree_walker();
    query = /* @__PURE__ */ __name2((method, ownerDocument, selectors) => {
    ...
    Document2 = class extends NonElementParentNode {
      ...
      get defaultView() {
        if (!window.has(this))
          window.set(this, new Proxy(globalThis, {
            set: /* @__PURE__ */ __name2((target, name, value) => {
              switch (name) {
            ...
            get: /* @__PURE__ */ __name2((globalThis2, name) => {
              switch (name) {
                case "addEventListener":
                case "removeEventListener":
                case "dispatchEvent":
      ...
      importNode(externalNode) {
        ...
        const upgrade = /* @__PURE__ */ __name2((element) => {
    ...
    setPrototypeOf(
      globalExports.Document = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function Document3() {
        illegalConstructor();
      }, "Document3"), "Document"),
      Document2
...
var init_document2 = __esm({
  "../node_modules/linkedom/esm/html/document.js"() {
    ...
    init_custom_element_registry();
    init_element3();
    createHTMLElement = /* @__PURE__ */ __name2((ownerDocument, builtin, localName, options) => {
...
var init_parser = __esm({
  "../node_modules/linkedom/esm/dom/parser.js"() {
    ...
    DOMParser = class _DOMParser {
      static {
        __name(this, "_DOMParser");
      }
      static {
        __name2(this, "DOMParser");
      }
...
var init_esm10 = __esm({
  "../node_modules/linkedom/esm/index.js"() {
    ...
    init_node_list();
    init_node_filter();
    parseHTML = /* @__PURE__ */ __name2((html, globals = null) => new DOMParser().parseFromString(
      html,
      "text/html",
      globals
    ).defaultView, "parseHTML");
    __name2(Document4, "Document");
...
__name(stripBridge, "stripBridge");
var BRIDGE_SCRIPT_ID;
var BRIDGE_STYLE_ID;
var init_html_editor = __esm({
  "../lib/html-editor.ts"() {
    "use strict";
    init_functionsRoutes_0_428505668336725();
    init_esm10();
    BRIDGE_SCRIPT_ID = "bloxx-editor-bridge";
    BRIDGE_STYLE_ID = "bloxx-editor-styles";
    __name2(stripBridge, "stripBridge");
  }
});
async function enhanceWithClaude(apiKey, html) {
  try {
    const res = await fetch("https://api.anthropic.com/v1/messages", {
      method: "POST",
      headers: {
...
__name(enhanceWithClaude, "enhanceWithClaude");
var ENHANCE_PROMPT;
var onRequestPost6;
var init_save = __esm({
  "api/save.ts"() {
    ...
    init_functionsRoutes_0_428505668336725();
    init_html_editor();
    ENHANCE_PROMPT = `You are a web standards expert. You receive an HTML page and must return an IMPROVED version.
...
Output the COMPLETE <!DOCTYPE html> document.`;
    __name2(enhanceWithClaude, "enhanceWithClaude");
    onRequestPost6 = /* @__PURE__ */ __name2(async (context) => {
      ...
      const key2 = `${site}/drafts/${page}.html`;
      if (etag) {
        const existing = await env.BLOXX_SITES.head(key2);
      ...
      const putResult = await env.BLOXX_SITES.put(key2, cleanHtml, {
        httpMetadata: { contentType: "text/html" }
      });
      try {
        if (env.COLLAB_ROOM) {
...
function executeToolCalls(toolCalls, currentSchemas) {
  let schemas = [...currentSchemas];
  for (const call of toolCalls) {
    switch (call.name) {
      case "set_schemas":
        schemas = call.input.schemas || [];
        break;
      case "update_property": {
        const idx = call.input.schemaIndex;
        if (idx >= 0 && idx < schemas.length) {
          schemas[idx] = { ...schemas[idx], [call.input.property]: call.input.value };
        }
        break;
      }
      case "add_schema":
        if (call.input.schema) {
          schemas.push(call.input.schema);
        }
        break;
    }
  }
...
__name(executeToolCalls, "executeToolCalls");
var SCHEMA_TOOLS;
var SYSTEM_PROMPT2;
var onRequestPost7;
var init_schema_update = __esm({
  "api/schema-update.ts"() {
    "use strict";
    init_functionsRoutes_0_428505668336725();
    SCHEMA_TOOLS = [
      {
        name: "set_schemas",
        description: "Replace all JSON-LD schemas for this page. Use this to set the complete list of JSON-LD schema objects.",
        input_schema: {
          type: "object",
          properties: {
            schemas: {
              type: "array",
              description: "Array of complete JSON-LD schema objects (each with @context, @type, and properties)",
              items: { type: "object" }
            }
          },
          required: ["schemas"]
      ...
      },
      {
        ...
        description: "Update a single property on an existing schema by index.",
        input_schema: {
          type: "object",
          properties: {
            schemaIndex: {
              type: "number",
              description: "Index of the schema to update in the currentSchemas array"
            },
            property: {
              type: "string",
              description: 'The schema property name to set (e.g. "name", "image", "description")'
            },
            value: {
              description: "The value to set for this property (string, object, or array)"
            }
          },
          required: ["schemaIndex", "property", "value"]
        }
      },
      {
        name: "add_schema",
        description: "Add a new JSON-LD schema object to the page.",
        input_schema: {
          type: "object",
          properties: {
            schema: {
              type: "object",
              description: "A complete JSON-LD schema object with @context, @type, and properties"
            }
          },
          required: ["schema"]
        }
    ...
    SYSTEM_PROMPT2 = `You are a Schema.org JSON-LD expert. Given section HTML and current schemas, return updated JSON-LD that accurately reflects the page content.

RULES:
1. Always use https://schema.org as @context.
2. Cover all visible content: text (name, headline, description), images, links, ratings, prices, addresses, dates.
3. Choose the most specific @type (e.g. Product, LocalBusiness, Article, FAQPage, Service, WebPage, Organization).
4. If current schemas exist, update them to reflect content changes rather than replacing unnecessarily.
5. If no schemas exist, create appropriate ones based on the HTML content.
6. Use set_schemas when multiple schemas need updating, update_property for single-field changes, add_schema for new types.
7. Keep schemas concise \u2014 only include properties that have actual values in the HTML.
8. For images, use the full URL from src attributes.
9. For prices, include priceCurrency if detectable.`;
    __name2(executeToolCalls, "executeToolCalls");
    onRequestPost7 = /* @__PURE__ */ __name2(async (context) => {
      ...
      const { sectionHtml, currentSchemas, componentType } = body;
      if (!sectionHtml) {
        return Response.json({ ok: false, error: "Missing sectionHtml" }, { status: 400 });
      }
      try {
        const userMessage = `Section HTML (${componentType || "unknown"} component):

${sectionHtml.substring(0, 6e3)}

Current JSON-LD schemas:
${JSON.stringify(currentSchemas || [], null, 2)}

Analyze the HTML and update the JSON-LD schemas to accurately reflect all visible content. Use the appropriate tool(s).`;
        const res = await fetch("https://api.anthropic.com/v1/messages", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
        ...
        const schemas = executeToolCalls(toolCalls, currentSchemas || []);
        return Response.json({ ok: true, schemas });
      } catch (err) {
...
`;
    onRequest = /* @__PURE__ */ __name2(async (context) => {
      ...
      if (pathParts[1] === "_asset") {
        ...
        const key3 = `${site}/assets/${assetPath}`;
        const obj2 = await env.BLOXX_SITES.get(key3);
        if (!obj2) return new Response("Asset not found", { status: 404 });
        const headers = new Headers();
        obj2.httpMetadata?.contentType && headers.set("Content-Type", obj2.httpMetadata.contentType);
        headers.set("Cache-Control", "public, max-age=3600");
        return new Response(obj2.body, { headers });
      }
      const page = pathParts.slice(1).join("/");
      const key2 = `${site}/drafts/${page}.html`;
      const obj = await env.BLOXX_SITES.get(key2);
      if (!obj) {
        return new Response(`Page not found: ${key2}`, { status: 404 });
      }
      let html = await obj.text();
      html = html.replace(
        /(href|src)="(?!https?:\/\/|\/\/|#|mailto:|tel:)([^"]+)"/g,
        (match2, attr, path) => {
          if (path.endsWith(".html")) return match2;
...
var routes;
var init_functionsRoutes_0_428505668336725 = __esm({
  "../.wrangler/tmp/pages-gXYSU7/functionsRoutes-0.428505668336725.mjs"() {
    "use strict";
    init_ai();
    init_collab();
    init_components();
...
// .wrangler/tmp/bundle-MVXDey/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-MVXDey/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9491651213849086.js.map
